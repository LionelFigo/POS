...
if(mysqli_num_rows($ambil_nota_beli) > 0){
    mysqli_data_seek($ambil_nota_beli, 0);
}
?>
<!DOCTYPE html>
<html lang="en">
<?php include '../css.php'; ?>
<?php $hal = 'total_beli_superadmin'; ?>
<!--
`body` tag options:
      ...
      <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><b>Laporan Total Pembelian</b></h3>
            </div>
            <div class="card-body">
                            ...
                            while($data_nota_beli = mysqli_fetch_assoc($ambil_nota_beli)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      $bayar = 0;
                                      if($status == 'L'){
                                         echo 'Rp '.number_format($total_pembelian, 0, ',', '.').'';
                                      }elseif($status == '2'){
                                        $bayar = $total_pembelian * 0.25;
                                         echo 'Rp '.number_format($bayar, 0, ',', '.').'';
                                      }elseif($status == '3'){
                                        $bayar = $total_pembelian * 0.50;
                                         echo 'Rp '.number_format($bayar, 0, ',', '.').'';
                                      }else{
                                        $bayar = $total_pembelian * 0.75;
                                        echo 'Rp '.number_format($bayar, 0, ',', '.').'';
                                      }
                                      ?>
                                    </td>
