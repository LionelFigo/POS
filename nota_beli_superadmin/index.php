        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $ambil_nota_beli = mysqli_query($koneksi, "SELECT * from nota_beli")or die(mysqli_error($koneksi));
                        ...
                        if($rv > 0){
                            ...
                            while($data_nota_beli = mysqli_fetch_assoc($ambil_nota_beli)){
                                ...
                                <tr>
                                    ...
                                    <td><?= $keterangan ?></td>
                                    <td>
                                        <a href="../detail_notabeli_superadmin?kode_nota=<?= $kode_nota ?>" type="button" class="btn btn-success btn-sm"><i class="fas fa-list"></i></a>
